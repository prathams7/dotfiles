...
--
myLayout = avoidStruts $ spacing 4 $ (tiled ||| Full)
  where
...
--
main = do 
        spawnPipe "xmobar -x 0 /home/shanu/.config/xmobar/xmobarrc0"
        spawnPipe "xmobar -x 1 /home/shanu/.config/xmobar/xmobarrc1"
